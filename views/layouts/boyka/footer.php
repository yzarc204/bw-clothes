        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="footer-info-area">
            <div class="footer-logo">
              <a href="#"><img src="assets/boyka/images/logo/logo_footer.png" alt="" /></a>
            </div>
            <div class="desc_footer">
              ...
              <p>
                <i class="fa fa-phone"></i> <span> (0) 800 456 789</span>
              </p>
              <p>
                <i class="fa fa-envelope-open-o"></i>
                <span> contact@demoemail.com</span>
              </p>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-7">
          <div class="copy-right">
            <p>
              Copyright 2021 <a href="#">Boyka</a>. All Rights Reserved
            </p>
          </div>
        </div>
        <div class="col-lg-6 col-md-5">
          <div class="payment">
            <img src="assets/boyka/images/icon/1.png" alt="" />
          </div>
        </div>
      </div>
    </div>
