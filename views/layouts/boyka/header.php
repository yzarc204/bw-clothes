            ...
            <div class="col-lg-8 order-2 order-lg-1">
              <div class="top-left-wrap">
                <ul class="phone-email-wrap">
                  ...
                  <li>
                    <i class="fa fa-envelope-open-o"></i> yourmail@domain.com
                  </li>
                </ul>
                <ul class="link-top">
                  <li>
              ...
              <div class="top-selector-wrapper">
                <ul class="single-top-selector">
                  ...
                  <li class="language list-inline-item">
                    <div class="btn-group">
                      <button class="dropdown-toggle">
                        <img src="assets/boyka/images/icon/la-1.jpg" alt="" />
                        English <i class="fa fa-angle-down"></i>
                      </button>
                      <div class="dropdown-menu">
                        <ul>
                          <li>
                            <a href="#"><img src="assets/boyka/images/icon/la-1.jpg" alt="" />
                              English</a>
                          </li>
                          <li>
                            <a href="#"><img src="assets/boyka/images/icon/la-2.jpg" alt="" />
                              Français</a>
                          </li>
                        </ul>
                      </div>
                ...
                <nav class="main-navigation">
                  <ul>
                      ...
                      <!-- <ul class="mega-menu">
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="shop-list-fullwidth.html">Shop Lsiting View</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <a href="blog.html">Products Details Style</a>
                          <ul>
                            <li>
                              <a href="product-details-vertical.html">Single Product Tab Left</a>
                            </li>
                            <li>
                              <a href="product-details-vertical-right.html">Single Product Tab Right</a>
                            </li>
                            <li>
                              <a href="product-details-carousel.html">Single Product Carousel</a>
                            </li>
                            <li>
                              <a href="product-details-gallery.html">Single Product Gallery Left</a>
                            </li>
                            <li>
                              <a href="product-details-gallery-right.html">Single Product Gallery Right</a>
                            </li>
                            <li>
                              <a href="product-details-sticky.html">Single Product Sticky Left</a>
                            </li>
                            <li>
                              <a href="product-details-sticky-right.html">Single Product Sticky Right</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                      ...
                      <ul class="mega-menu four-column-menu">
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="my-account.html">My Account Page</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <a href="blog.html">Column two</a>
                          <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="blog-details-slider.html">Blog Details Slider</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <ul class="sub-menu">
                        <li>
                          <a href="blog-col-2.html">Blog Grid 2 Layout</a>
                        </li>
                        <li>
                          <a href="blog-col-3.html">Blog Grid 3 Layout</a>
                        </li>
                        <li><a href="blog.html">Blog Left Sidebar</a></li>
                        <li>
                          <a href="blog-details-right-sidebar.html">Blog Right Sidebar</a>
                        </li>
                        <li>
                          <a href="blog-details-slider.html">Blog Details Left Slider</a>
                        </li>
                        <li>
                          <a href="blog-details-right-sidebar.html">Blog Details Right Slider</a>
                        </li>
                      </ul>
                    </li>
